...
public class MyStaggeredViewAdapter extends RecyclerView.Adapter<MyStaggeredViewAdapter.MyRecyclerViewHolder> {
    ...
    public void onBindViewHolder(final MyRecyclerViewHolder holder, final int position) {
        ...
        holder.mTex.setText(Datas.get(position).getTitle());
    ...
    public static class MyRecyclerViewHolder extends RecyclerView.ViewHolder {
        public MyRecyclerViewHolder(View itemView){
            super(itemView);
            mImg = ((ImageView) itemView.findViewById(R.id.id_imageview));
            mTex = ((TextView) itemView.findViewById(R.id.id_textview));
        }
